...
<template>
  <div class="max-w-5xl mx-auto">
    ...
    <h1 class="mt-5 text-4xl text-center font-michroma">Valorant</h1>
    <div class="mt-5 font-exo px-7">
      <h2 class="text-lg font-bold">Description</h2>
      <ul class="mt-2">
        <li class="flex items-center mt-1">
          <span class="mr-1 material-icons">east</span>The game will be in 5v5 mode
        </li>
        <li class="flex items-center mt-1">
      ...
      <div class="flex justify-center mt-10">
        <a href="https://forms.gle/G7Ln7UF2ueg9WG4a7">
          <div
