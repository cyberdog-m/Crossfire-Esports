<template>
  <div class="max-w-5xl mx-auto">
    <div class="h-[15rem] md:h-[22rem] overflow-hidden">
      <img
        src="../../assets/detail-view/forza.jpg "
        alt="game cover photo"
        class="object-cover w-full h-full"
      />
    </div>
    <h1 class="mt-5 text-4xl text-center font-michroma">Forza Horizon</h1>
    <div class="mt-5 font-exo px-7">
      ...
      <p>Monday,<span class="font-bold"> 28 November </span>2022</p>
      ...
      <div class="flex justify-center mt-10">
        <a href="https://forms.gle/WiMpqo11G7PT3LXN7">
          <div
